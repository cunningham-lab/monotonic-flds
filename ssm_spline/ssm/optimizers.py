...
#
# @unflatten_optimizer_step
# def adam_step(value_and_grad, x, itr, state=None, step_size=0.01, b1=0.9, b2=0.999, eps=10**-8): #was .001
#     """
...
@unflatten_optimizer_step
def adam_step2(value_and_grad, x, itr, state=None, step_size=0.003, b1=0.9, b2=0.999, eps=10**-8): #was .001
    """
    Adam as described in http://arxiv.org/pdf/1412.6980.pdf.
    It's basically RMSprop with momentum and some correction terms.
    """
...
def _generic_sgd(method, loss, x0, callback=None, num_iters=200, state=None, full_output=False, **kwargs):
    ...
    """
    step = dict(sgd=sgd_step, rmsprop=rmsprop_step, adam=adam_step, adam2=adam_step2)[method]
